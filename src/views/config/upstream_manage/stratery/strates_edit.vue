                ...
                <template v-else>
                  ...
                  <el-popover placement="right" width="420" trigger="hover">
                    ...
                    <div class="event_popover">
                      <div v-for="e_t_r in scope.row.risk_body" style="margin-bottom: 15px;">
                        <!-- {{scope.row.risk_body}} -->
                        <div class="l_e_t_r">
...
export default {
      ...
      this.$valid([
        ...
        .then(() => {
          this.$store.dispatch('stratery/stratesEditSave', {
            name: this.strates_edit_name_navtive,
            id: this.$router.currentRoute.query.id,
            t_ids: this.strates_info_ids
          })
        })
    },
  ...
  watch: {
    ...
    strates_edit_name (val) {
      this.strates_edit_name_navtive = val
    }
  },
  mounted () {
    this.$store.dispatch('stratery/stratesEdit', {
      id: this.$router.currentRoute.query.id
    })
      .then(() => {
        this.strates_edit_name_navtive = this.strates_edit_name
      })
  }
}
</script>
